                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Vehiculo <small>Crud Vehiculos</small>
                        </h1>
                        <a class="btn btn-primary" href="crearvehiculo.jsp"> Crear vehiculo </a>
                        <p><br/></p>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    for (Vehiculo us : dato) {
                                        if(!us.getModelo().equals("")){
                                %>
                                    <tr>
                                        <td><%=us.getIdVehiculo()%></td>
                                        <td><%=us.getModelo()%></td>
                                        <td><%=us.getMarca()%></td>
                                        <td><%=us.getSerie()%></td>
                                        <td>
                                            <button type="submit"><a href="modificarvehiculo.jsp?id=<%=us.getIdVehiculo()%>">Modificar</a></button>
                                            <button type="submit"><a href="Controlador?id=<%=us.getIdVehiculo()%>&val=eliminar">Eliminar</a></button>
                                        </td>
