...
public class UsuarioJerseyClient {
    ...
    private static final String BASE_URI = "http://localhost:8080/UsuarioRestWS/webresources";

    public UsuarioJerseyClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("com.persistence.usuario");
    }
